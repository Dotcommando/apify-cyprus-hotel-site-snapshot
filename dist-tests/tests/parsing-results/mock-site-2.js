...
export const MOCK_SITE_2_PAGES = [
    ...
    P({
        ...
        html: '<!doctype html><html><head><title>Rooms | Site 2 Mock Resort</title><meta name="description" content="Rooms and suites at Site 2 Mock Resort."></head><body><h1>Rooms & Suites</h1><a href="/book/">Book</a></body></html>',
    }),
    P({
        ...
        html: '<!doctype html><html><head><title>Offers | Site 2 Mock Resort</title><meta name="description" content="Special offers and packages."></head><body><h1>Offers</h1><p>Member rates available.</p></body></html>',
    }),
    P({
        ...
        html: '<!doctype html><html><head><title>Dining | Site 2 Mock Resort</title></head><body><h1>Dining</h1><p>Mediterranean cuisine.</p></body></html>',
    }),
    P({
        ...
        html: '<!doctype html><html><head><title>Spa | Site 2 Mock Resort</title></head><body><h1>Spa & Wellness</h1><p>Signature treatments.</p></body></html>',
    }),
    P({
        ...
        html: '<!doctype html><html><head><title>Contact | Site 2 Mock Resort</title></head><body><h1>Contact</h1><a href="mailto:reservations@site-2.mock">Email</a></body></html>',
    }),
    P({
        ...
        html: '<!doctype html><html lang="de"><head><title>Startseite | Site 2 Mock Resort</title></head><body><h1>Willkommen</h1></body></html>',
    }),
    P({
        ...
        html: '<!doctype html><html lang="ru"><head><title>Главная | Site 2 Mock Resort</title></head><body><h1>Добро пожаловать</h1></body></html>',
    }),
    P({
